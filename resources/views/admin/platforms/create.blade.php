<x-app-layout title="Nueva plataforma">
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex flex-col gap-1">
                <p class="text-xs uppercase tracking-widest text-slate-200/70">Administración</p>
                <h1 class="text-3xl font-semibold text-white">Crear plataforma</h1>
            </div>
    ...
    <div class="mx-auto max-w-3xl px-6 py-10 sm:px-10 lg:px-12">
        ...
        <form method="POST" action="{{ route('admin.platforms.store') }}" class="space-y-8">
            @csrf
